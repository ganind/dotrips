			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="social"> Rejoignez-nous sur nos réseaux sociaux </div>
					...
					<div class="user_box ml-auto"> <!-- Accès espace client -->
					<div class="user_box_login user_box_link"><a href="#">S'Identifier</a></div>
					<div class="user_box_register user_box_link"><a href="#">Créer un compte</a></div>
					</div>
				...
				<div class="row">
					...
					<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<!-- Recheche sur tout le site-->

							<form id="search_form" class="search_form bez_1">
							<input type="search" class="search_content_input bez_1">
							</form>

							<div class="content_search ml-lg-0 ml-auto"> <!-- LUPE -->
